...
class __TwigTemplate_c3798ea9d72252dce9dff7165ecb0763086544cb5f863214114b1f58f8a67dad extends \Twig\Template
{
    private $source;
    private $macros = [];
...
($context["long"] ?? null)) ? (("filter-tips__item--id-" . \Drupal\Component\Utility\Html::getClass($this->sandbox->ensureToStringAllowed(twig_get_attribute($this->env, $this->source, $context["item"], "id", [], "any", false, false, true, 50), 50, $this->source)))) : (""))];
  ...
  ";
    ...
    {
        return new Source("", "core/themes/claro/templates/filter/filter-tips.html.twig", "D:\\Projects\\drupal\\thebar\\core\\themes\\claro\\templates\\filter\\filter-tips.html.twig");
    }
