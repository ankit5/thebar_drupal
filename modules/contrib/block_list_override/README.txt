...
-------------
    ...
    2. Navigate to Administration > Configuration > System > Block List Override   Settings and list each name or value on a new line in the appropriate section. The user has the option to identify blocks to be removed by name or prefix, or provide a regex for more complex matching options.
    3. Save.
