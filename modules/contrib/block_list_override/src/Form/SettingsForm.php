...
class SettingsForm extends ConfigFormBase {
  ...
  public function buildForm(array $form, FormStateInterface $form_state) {
    ...
    $description[] = $this->t("See a list of all blocks in the <a href=':url'> " .
      ...
      "lists will display the blocks that remain after listed blocks " .
      ...
      "results you intended.", [
        ":url" => "/admin/config/block_list_override/system-list",
        ":url2" => "/admin/config/block_list_override/layout-list",
      ])->__toString();
